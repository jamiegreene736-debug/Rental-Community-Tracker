...
33. **Single-listing drafts share the `community_drafts` table with
    ...
    **Every summary EXPLAINS its own occupancy (2026-07-18).** Guests
    ...
    (`describesSleepingCapacity`) is deliberately GENEROUS — any wording
    naming a sofa bed plus both numbers counts — because a false
    negative appends a DUPLICATE explanation to live guest copy.
