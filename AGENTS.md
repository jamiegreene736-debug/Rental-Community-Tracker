...
3. **Ships dark behind `PLATFORM_ASSISTANT_ENABLED`** (+ `ANTHROPIC_API_KEY`).
   `GET /api/assistant/status` gates the client dock; it renders admin-only.
