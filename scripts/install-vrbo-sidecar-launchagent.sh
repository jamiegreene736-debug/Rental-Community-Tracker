...
SIDECAR_CAPTCHA_WINDOW_BOUNDS="${SIDECAR_CAPTCHA_WINDOW_BOUNDS:-40,60,1320,820}"
...
export SIDECAR_WARM_LOCAL_CHROME_ON_STARTUP="${SIDECAR_WARM_LOCAL_CHROME_ON_STARTUP}"
export SIDECAR_IDLE_CHROME_RESET_ENABLED="${SIDECAR_IDLE_CHROME_RESET_ENABLED}"
...
export SIDECAR_CAPTCHA_WINDOW_BOUNDS="${SIDECAR_CAPTCHA_WINDOW_BOUNDS}"
