...
# Keep eight sidecar Chrome windows visible in a compact 4-by-2 monitor grid;
# do not minimize/maximize them.
...
SIDECAR_CHROME_VISIBLE_SIZE="${SIDECAR_CHROME_VISIBLE_SIZE:-400,420}"
...
SIDECAR_CHROME_VISIBLE_GRID_GAP_Y="${SIDECAR_CHROME_VISIBLE_GRID_GAP_Y:-0}"
SIDECAR_CHROME_VISIBLE_POSITIONS="${SIDECAR_CHROME_VISIBLE_POSITIONS:-1440,60;1840,60;2240,60;2640,60;1440,480;1840,480;2240,480;2640,480}"
