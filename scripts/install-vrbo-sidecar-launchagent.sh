...
# accuracy. Slots intentionally overlap into two piles so every worker gets a
# 1280x900 viewport without consuming the whole monitor.
...
SIDECAR_CHROME_VISIBLE_POSITIONS="${SIDECAR_CHROME_VISIBLE_POSITIONS:-1440,60;2744,60;1440,60;2744,60;1440,60;2744,60;1440,60;2744,60}"
