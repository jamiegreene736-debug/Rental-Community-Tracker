...
DECODO_PROXY_USERNAME_EXPORT="$(quote_for_shell "${DECODO_PROXY_USERNAME}")"
DECODO_PROXY_PASSWORD_EXPORT="$(quote_for_shell "${DECODO_PROXY_PASSWORD}")"
...
export DECODO_PROXY_HOST="${DECODO_PROXY_HOST}"
export DECODO_PROXY_PORT="${DECODO_PROXY_PORT}"
export DECODO_PROXY_USERNAME=${DECODO_PROXY_USERNAME_EXPORT}
export DECODO_PROXY_PASSWORD=${DECODO_PROXY_PASSWORD_EXPORT}
