...
export class DatabaseStorage implements IStorage {
  ...
  async upsertPhotoListingCheck(data: InsertPhotoListingCheck): Promise<PhotoListingCheck> {
    const update = {
      ...
      airbnbAddressStatus: data.airbnbAddressStatus ?? "unknown",
      vrboAddressStatus: data.vrboAddressStatus ?? "unknown",
      bookingAddressStatus: data.bookingAddressStatus ?? "unknown",
      addressMatches: data.addressMatches ?? null,
