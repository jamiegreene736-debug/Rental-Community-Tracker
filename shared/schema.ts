...
// ── Approval-based virtual staging ──
// A job records one unit-level generation run. Candidates remain separate
// from the active top-level gallery until an operator explicitly confirms a
// selection. original_filename always names the immutable source asset.
