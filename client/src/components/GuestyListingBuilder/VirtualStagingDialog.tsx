                        ...
                        <>
                          ...
                          <div className="mt-3">
                            ...
                            <p className="mt-1 text-xs text-muted-foreground">
                              Replaces this preview with a strict new version: the unit's bones stay fixed while every eligible finish and furnishing visibly changes in the same style. Open space stays open.
                            </p>
                          </div>
