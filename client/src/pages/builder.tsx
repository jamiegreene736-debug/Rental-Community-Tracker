...
export default function Builder() {
  ...
  const propertyData = useMemo<GuestyPropertyData | null>(() => {
    ...
    return {
      ...
      bookingSettings: {
        // Standing operator policy (2026-07-18, was 5): 4-night minimum on every
        // listing. Matches GuestyListingBuilder's DEFAULT_BOOKING_RULES so a
        // full-build push never publishes a listing below the 4-night floor.
        minNights: 4,
        maxNights: 60,
